...
<div id="k2Container" class="lectures_item shopTpl itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader">
	  ...
	  <!-- Item title -->
	  <h2 class="900 itemTitle2">
	  <?php echo htmlspecialchars_decode($this->item->title); ?> </h2>
	  <?php endif; ?>
  ...
  <div class="itemBody project_table">
	  ...
	  <div class="itemExtraFields">
	  	...
	  	<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?> type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
				...
				<span alt="<?php echo $extraField->name; ?>" class="itemExtraFieldsValue"><?php echo $extraField->value; ?></span>
				<?php endif; ?>
			</li>
			<?php endif; ?>
			<?php endforeach; ?>
	  ...
	  <?php echo $this->item->event->K2AfterDisplay; ?>
	   ...
	   <div class="social_share">
            ...
            <div class="yashare-auto-init" data-yashareL10n="ru"
             data-yashareType="none" data-yashareQuickServices="vkontakte,facebook,twitter,pinterest,lj,gplus" data-yashareImage="<?php echo $this->baseurl ?>/templates/archstruktura_black/images/logo1.png"
            serviceSpecific: {
              twitter: {
               image: '<?php echo $this->baseurl ?>/templates/archstruktura_black/images/logo1.png'
               }
            }
            >
            </div>
	  ...
	  <!-- Item Image -->
	   <div class="itemImageBlock2 project_gallery">
