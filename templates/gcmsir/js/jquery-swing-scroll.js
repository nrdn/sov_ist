$.fn.swingScroll = function(options) {
	...
	var $columns = opts.columns ? $(this).children(opts.columns) : $(this).children();
			$columns.each(function() {
				var column_inner = $('<div/>', {'class': 'column_inner_2'});
	...
	var scrollColumns = function(event) {
		...
		var current_inner_height = $this.children('.column_inner_2').height();
		...
		$columnsCheck.each(function() {
			...
			var check_inner_height = $this.children('.column_inner_2').height();
